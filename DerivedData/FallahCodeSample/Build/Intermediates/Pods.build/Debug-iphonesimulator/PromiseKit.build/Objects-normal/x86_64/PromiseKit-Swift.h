...
@interface NSObject (SWIFT_EXTENSION(PromiseKit))
@end


@interface NSNotificationCenter (SWIFT_EXTENSION(PromiseKit))
@end
...
@interface NSURLResponse (SWIFT_EXTENSION(PromiseKit))
@end


@interface NSURLSession (SWIFT_EXTENSION(PromiseKit))
@end
